      ...
      <header>
        ...
        <nav className={`menu ${menuOpen ? 'open' : ''}`}>
          <ul>
            ...
            <li><a href="/users">登録者一覧</a></li>
            <li><a href="/create-info">新規お知らせ投稿</a></li>
            <li><a href="/create-manager-form">管理者ユーザー追加</a></li>
            <li><a href="/words">単語リスト一覧/編集</a></li>
            <li><a href="/create-new-word">単語リスト新規登録</a></li>
